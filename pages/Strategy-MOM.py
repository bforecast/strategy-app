...
from utils.component import input_symbols, input_dates, button_SavePortfolio, check_password, input_SymbolsDate
from vbt_strategy.MOM import MOM_MaxSR, MomStrategy
